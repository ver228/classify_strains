...
#    fields2copy = ['experiments_data', 'skeletons_groups', 'snps_data', 'strains_codes']
#    
#    with tables.File(data_file, 'r') as fid:
#        data2copy = {}
#        for k in fields2copy:
#            data2copy[k] = fid.get_node('/' + k)[:]        

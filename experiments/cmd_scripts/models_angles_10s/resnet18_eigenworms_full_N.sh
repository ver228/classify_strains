...
python $HOME/classify_strains/nn/train.py --model_name resnet18 --dataset SWDB --data_file None --is_reduced True --sample_size_seconds 10 --sample_frequency_s 0.04 --n_batch 32 --transform_type eigenworms_full --is_normalized True --n_epochs 200

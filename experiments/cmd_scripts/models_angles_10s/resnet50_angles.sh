...
python $HOME/classify_strains/nn/train.py --model_name resnet50 --dataset SWDB --data_file None --is_reduced True --sample_size_seconds 10 --sample_frequency_s 0.04 --n_batch 32 --transform_type angles --is_normalized False --n_epochs 200
